...
INCFLAGS=-i="C:\WATCOM\h\nt;C:\WATCOM\h;include;$(FLTK_DIR);$(FLTK_DIR)\include;utils"
CFLAGS=$(INCFLAGS) -w3 -e25 -en -zq -otexan -d2 -os -6r -bt=nt -fo=.obj -mf -br -bm -dWIN32
...
OBJ1=$(OBJDIR)\yyy_channel_ui.obj $(OBJDIR)\yyy_channel_core.obj 
...
OBJ4=$(OBJDIR)\yyy_date.obj $(OBJDIR)\yyy_prefs.obj $(OBJDIR)\yyy_chat_widget.obj
...
$(OBJDIR)\yyy_prefs.obj: $(YYY_PREFS_DEP)
	$(CC) yyy_prefs.c $(CFLAGS)
	move /Y yyy_prefs.obj $(OBJDIR)
